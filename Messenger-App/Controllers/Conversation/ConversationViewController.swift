...
class ConversationViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private let spinnerr = JGProgressHUD(style: .dark)
    ...
    override func viewDidLoad() {
        ...
        noConversationlabel1.isHidden = true
...
//        present(navVc, animated: true)
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: "NewConversationViewController")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vc = ChatViewController(with: "saad", id: "1" )
        vc.title = "saad alajlan"
